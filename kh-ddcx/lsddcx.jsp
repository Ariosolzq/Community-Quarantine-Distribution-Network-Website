...
<form method="POST" action="lsddcx.jsp">
	<table border="1" width="100%">
		<tr>
			<td colspan="3" bgcolor="#E6F7FF"><font face="华文细黑"><a href="../index.htm">
			<font size="4">主页</font></a><font size="4">-&gt;个人历史订单查询</font></font></td>
		</tr>
		<tr>
			<td colspan="3" id="s1">
		...
		<tr>
			<td width="36%"><font face="微软雅黑">查询方式：<input type="radio" value="kehudianhua" checked name="fangshi">客户电话 
	...
	<table border="1" width="100%" id="table1">
		<tr>
			...
			温馨提示：为保护您与他人的隐私，居民需要输入精确的个人信息才可以点击“提交”按钮查询本人的订单。</font></td>
		</tr>
	</table>
</form>
...
<table border="1" width="100%">
	...
	<tr>
		...
		<td align="center"><font face="微软雅黑">订单详情</font></td>
	</tr>
	...
	//执行查询SQL语句
	//执行查询SQL语句
	String sql = "select * from ddjbxx where " + fangshi + " = '" + tiaojian + "'";
	...
	while (rs.next()){
		...
		String paisongriqi = rs.getString("paisongriqi");
	...
	<tr>
		...
		<td align="center"><font face="微软雅黑"><a href="xq.jsp?bianhao=<%= bianhao %>">查询</a></font></td>
	</tr>
