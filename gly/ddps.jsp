...
<title>订单管理</title>
<!--引入信息检验文件-->
<script src="ddps.js" language="javascript"></script>
<!--引入样式文件-->
...
<body>
<form name="form1" onsubmit="return checkform()" method="POST" action="zxddps.jsp">
	<div align="center">
		<table border="1" width="69%" cellspacing="1" cellpadding="3" height="484" bordercolor="#000000" id="table">
			<tr>
				<td colspan="2" bgcolor="#E6F7FF">
				<font face="华文细黑">
				<a href="../index.htm"><font size="4">主页</font></a><font size="4">-&gt;<a href="ddcx.jsp">订单查询/派送/删除</a>-&gt;派送</font></font></td>
			</tr>
			<tr>
				<td colspan="2">
				<p align="center" id="s1"><font face="微软雅黑">请为居民派送商品</font></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td width="28%" id="s2" style="text-align: center">
				<font face="微软雅黑">商品</font></td>
				<td width="70%"><font face="微软雅黑">商品详情及选购</font></td>
			</tr>
                ...
                <tr>
                    ...
                    <td width="70%"><font face="微软雅黑"><input type="text" name="bianhao" size="20" value="<%=bianhao%>"  readonly></font></td>
                </tr>
				<tr>
				    <td width="28%" id="s2" style="text-align: center">
				    ...
				    <td width="70%">
				        <font face="微软雅黑">
				        <input type="checkbox" name="paisongrenyuan" value="石朴001" <%= (paisongrenyuan != null && paisongrenyuan.indexOf("石朴001") != -1) ? "checked" : "" %>>石朴001 
				        <input type="checkbox" name="paisongrenyuan" value="欧瑞榆002" <%= (paisongrenyuan != null && paisongrenyuan.indexOf("欧瑞榆002") != -1) ? "checked" : "" %>>欧瑞榆002 
				        <input type="checkbox" name="paisongrenyuan" value="毛彦哲003" <%= (paisongrenyuan != null && paisongrenyuan.indexOf("毛彦哲003") != -1) ? "checked" : "" %>>毛彦哲003
				        </font>
				        <font id="s3" face="微软雅黑">**请至少选择一位派送人员</font><font face="微软雅黑">
						</font>
				    </td>
				</tr>
				...
				<tr>
				    ...
				    <td width="70%"><font face="微软雅黑"><input type="text" name="paisongriqi" size="20" value="<%=paisongriqi%>" ></font><font id="s3" face="微软雅黑">**必须是有效日期，并符合“YYYY-MM-DD”格式</font></td>
				</tr>
				<tr>
				    <td width="28%" id="s2" style="text-align: center">
				    ...
				    <td width="70%">
				        <font face="微软雅黑">
				        <input type="radio" value="已送达" name="sfsd" <%=sfsd.equals("已送达") ? "checked" : ""%>>已送达
				        <input type="radio" value="未送达" name="sfsd" <%=sfsd.equals("未送达") ? "checked" : ""%>>未送达
				         
						</font>
				        <font id="s3" face="微软雅黑">**请根据实际情况填写</font><font face="微软雅黑">
						</font>
				    </td>
				</tr>
				<tr>
				    ...
				    <td width="70%"><font face="微软雅黑">共计：<input type="text" name="jine" size="11" readonly value="<%=jine%>"  readonly>元</font></td>
				</tr>
				<tr>
				    <td width="28%" id="s2" style="text-align: center">
					<font face="微软雅黑">客户姓名</font></td>
				    <td width="70%"><font face="微软雅黑"><input type="text" name="kehuxingming" size="20" value="<%=kehuxingming%>" readonly></font></td>
				</tr>
				<tr>
				    <td width="28%" id="s2" style="text-align: center">
					<font face="微软雅黑">客户电话</font></td>
				    <td width="70%"><font face="微软雅黑"><input type="text" name="kehudianhua" size="20" value="<%=kehudianhua%>" readonly></font></td>
				</tr>
				<tr>
				    <td width="28%" id="s2" style="text-align: center">
				...
				<tr>
				    ...
				    <td width="70%"><font face="微软雅黑"><textarea rows="8" name="beizhu" cols="35" readonly><%=beizhu%></textarea></font><font id="s3" face="微软雅黑">不多于20个汉字</font></td>
				</tr>			<tr>
				<td colspan="2">
				<p align="center"><font face="微软雅黑"><input type="submit" value="提交" name="B1" >&nbsp;
				<input type="reset" value="重置" name="B2"></font></td>
				</tr>				
		</table>
	</div>
	<p>　</p>
